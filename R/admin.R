...
#' @param expand Expands related entities inline, receives a comma-separated list of data types. Supported: tiles
...
#' @return A `data.frame` object.
dashboards_getdashboardsasadmin <- function(token, expand, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
dashboards_getdashboardsingroupasadmin <- function(token, groupId, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
dataflows_getdataflowsasadmin <- function(token, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
dataflows_getdataflowsingroupasadmin <- function(token, groupId, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
datasets_getdatasetsasadmin <- function(token, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
datasets_getdatasetsingroupasadmin <- function(token, groupId, expand, filter, skip, top) {
...
#' @param filter Filters the results based on a boolean condition, using 'Activity', 'UserId', or both properties. Supports only 'eq' and 'and' operators.
...
#' @return A `data.frame` object.
get_activity_events <- function(token, filter, continuationToken, endDateTime, startDateTime) {
...
#' @param expand Expands related entities inline 
#' @return A `data.frame` object.
get_capacities_as_admin <- function(token, expand) {
...
#' @param expand Expands related entities inline, receives a comma-separated list of data types. Supported: users, reports, dashboards, datasets, dataflows, workbooks
#' @param filter Filters the results based on a boolean condition
#' @param skip Skips the first n results. Use with top to fetch results beyond the first 5000.
#' @param top Returns only the first n results. This parameter is mandatory and must be in the range of 1-5000. 
#' @return A `data.frame` object.
groups_getgroupsasadmin <- function(token, expand, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
imports_getimportsasadmin <- function(token, expand, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
reports_getreportsasadmin <- function(token, filter, skip, top) {
...
#' @param top Returns only the first n results 
#' @return A `data.frame` object.
reports_getreportsingroupasadmin <- function(token, groupId, filter, skip, top) {
